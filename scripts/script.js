...
//   var $el = createElement('div');
//   var self = observable({ mount: mount, unmount: unmount, $el: $el });
...
//     var card = { name: name, pos: i, $el: $el, mount: mount, unmount: unmount, setSide: setSide, animateTo: animateTo };
//     console.log(card);
//     console.log('card')
//     var $el = createElement('div');
//     var self = observable({ mount: mount, unmount: unmount, card: card, rootx: x, rooty: y, name: name, $el: $el });
//     var $root;
...
//   function log(msg){
//     document.getElementById('topbar').innerHTML = msg;
//     console.log(msg);
//   };
...
//       this.avatar = Avatar(name, x - 100, y - 100);
//       this.avatar.mount($container);
//       this.avatar.card.animateTo({delay: 0, duration: 500, x: x - 100, y: y - 100});
//       this.speed = 100;
//     }
//     toString() {
//       return this.name;
...
//   var players = config.playerNames.map(function (name, index) {
//       return new Player(name, 200*(2*index - 1), 0, index);
//   });

//   var deck = Deck();
//   deck.mount($container);
//   deck.shuffle();
//   var table = Hand("table", 0, -100);
